...
import {
  ...
  BodyFatCalc,
  WaterIntakeCalc,
} from "@/components/calculator/HealthTools";
...
import {
  ...
  Stopwatch,
  TimeCalc,
} from "@/components/calculator/TimeTools";
...
import {
  ...
  QrGenerator,
  QrScanner,
} from "@/components/calculator/ScanTools";

import {
  PasswordGenerator,
  PasswordStrengthChecker,
} from "@/components/calculator/SecurityTools";
...
/*
 * IMPORTANT:
 * AiSolver imports @tanstack/react-start.
 *
 * That module can use server-side AsyncLocalStorage, which is not
 * available inside Android WebView.
 *
 * Therefore AiSolver MUST NOT be imported at application startup.
 * It is loaded only when the AI tab is opened on the web version.
 */
const AiSolver = lazy(() =>
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <div className="flex items-center gap-1.5">
            <Sheet>
              ...
              <SheetContent
                side="right"
                className="w-full p-3 sm:max-w-md"
              >
        ...
        <section className="space-y-4">
          ...
          >
            <TabsList className="glass-panel grid h-auto w-full grid-cols-4 gap-1 rounded-2xl p-1.5 sm:grid-cols-6 lg:grid-cols-12">
              <TabsTrigger
                value="standard"
                className="gap-1.5 rounded-xl py-2"
              >
            ...
            <TabsContent
              value="tools"
              className="animate-pop mt-4 space-y-4"
            >
