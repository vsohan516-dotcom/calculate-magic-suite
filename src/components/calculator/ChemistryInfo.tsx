    ...
    <div className="glass-panel p-4">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <div className="text-xs">Group: {info.group ?? "Not available"} · Period: {info.period ?? "Not available"}</div>
          <div className="text-xs">Block: {info.block ?? "Not available"} · Category: {info.category ?? "Not available"}</div>
        </div>
      </div>
      ...
      <div className="mt-4 grid gap-2">
        <div>
          ...
          <div className="text-sm">Electronic configuration: {info.electronicConfiguration ?? "Not available"}</div>
        </div>

        <div>
          <div className="text-xs uppercase text-muted-foreground">Physical properties</div>
          <div className="text-sm">State at room temp: {info.stateAtRoomTemp ?? "Not available"}</div>
        </div>

        <div>
          <div className="text-xs uppercase text-muted-foreground">Chemical properties</div>
          <div className="text-sm">Important compounds: {(info.importantCompounds && info.importantCompounds.join(", ")) ?? "Not available"}</div>
        </div>
      </div>
    </div>
  );
